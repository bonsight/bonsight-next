...
<h1>Data Strategy</h1>
<button class="btn-primary">Conversemos</button>
</div>
...
<div class="cta-band"><h2>¿Quieres ordenar tus datos?</h2><p>Conversemos sobre cómo una estrategia de datos puede transformar tu negocio.</p><button class="btn-white">Agendar conversación →</button></div>
