...
<div class="cta-band" data-animate><h2>${en ? 'Want to improve your conversion?' : '¿Quieres mejorar tu conversión?'}</h2><p>${en ? "Let's talk about converting more with the users you already have." : 'Hablemos sobre cómo convertir más con los usuarios que ya tienes.'}</p><button class="btn-white" data-route="/#contacto">${en ? 'Schedule a conversation →' : 'Agendar conversación →'}</button></div>
