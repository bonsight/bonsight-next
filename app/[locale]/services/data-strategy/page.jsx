...
<div class="cta-band" data-animate><h2>${en ? 'Want to organize your data?' : '¿Quieres ordenar tus datos?'}</h2><p>${en ? "Let's talk about how a data strategy can transform your business." : 'Conversemos sobre cómo una estrategia de datos puede transformar tu negocio.'}</p><button class="btn-white" data-route="/#contacto">${en ? 'Schedule a conversation →' : 'Agendar conversación →'}</button></div>
