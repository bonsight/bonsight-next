...
<div class="cta-band" data-animate><h2>${en ? 'Want your team to work better?' : '¿Quieres que tu equipo trabaje mejor?'}</h2><p>${en ? "Let's talk about optimizing the processes that are slowing down growth." : 'Conversemos sobre cómo optimizar los procesos que frenan el crecimiento.'}</p><button class="btn-white" data-route="/#contacto">${en ? 'Schedule a conversation →' : 'Agendar conversación →'}</button></div>
