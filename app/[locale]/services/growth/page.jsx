...
<div class="cta-band" data-animate><h2>${en ? 'Want to accelerate your growth?' : '¿Quieres acelerar tu crecimiento?'}</h2><p>${en ? "Let's talk about scaling your acquisition and improving your marketing investment." : 'Hablemos sobre cómo escalar tu adquisición y mejorar tu inversión en marketing.'}</p><button class="btn-white" data-route="/#contacto">${en ? 'Schedule a conversation →' : 'Agendar conversación →'}</button></div>
