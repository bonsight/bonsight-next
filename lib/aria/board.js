...
export async function createTask(token, sprintId, { title, status, proyectoId, responsableId, priority, taskType, severity, iniciativaId, startDate, endDate, estimatedHours, description }) {
