...
export async function generateReportDraft(experiment) {
  ...
  const prompt = `Sos el asistente de Labs de Bonsight, sintetizando el reporte de un experimento a partir de lo que el equipo ya registró — no inventes nada que no esté en los datos de abajo.
